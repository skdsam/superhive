export default {
  ...
  defaults: () => ({
    ...
    baseSurfaceStyle: 'background:linear-gradient(135deg,#0f1220,#1b2451);border:1px solid rgba(255,255,255,.15);border-radius:16px;padding:28px 26px;color:#eaf0ff;margin-bottom:60px;',
    style: ''
  }),
      ...
      <div data-surface="1" style="${mergeSurfaceStyle(p)}">
        <div style="display:flex;align-items:center;flex-wrap:wrap;gap:20px;">
          ...
          <div style="flex:1 1 320px;">
            ...
            <h1 style="margin:6px 0 8px 0;font-size:26px;line-height:1.2;">&nbsp;${html(p.title)}&nbsp;</h1>
